       ...
       <Grid container spacing={2}>
         ...
         <List>
          <ListItem disablePadding>
            <ListItemButton onClick={()=>navigate('/dashboard/displayallstates')}>
              <ListItemIcon>
                <InboxIcon />
              </ListItemIcon>
          ...
          <ListItem disablePadding>
            <ListItemButton onClick={()=>navigate('/dashboard/displayallcities')}>
              <ListItemIcon>
                <InboxIcon />
              </ListItemIcon>
          ...
          <ListItem disablePadding>
            <ListItemButton onClick={()=>navigate('/dashboard/displayallproperties')}>
              <ListItemIcon>
                <InboxIcon />
              </ListItemIcon>
          ...
          <ListItem disablePadding>
            <ListItemButton onClick={()=>navigate('/dashboard/displayallsubproperties')}>
              <ListItemIcon>
                <InboxIcon />
              </ListItemIcon>
          ...
          <ListItem disablePadding>
            <ListItemButton onClick={()=>navigate('/dashboard/displayallamenities')}>
              <ListItemIcon>
                <InboxIcon />
              </ListItemIcon>
